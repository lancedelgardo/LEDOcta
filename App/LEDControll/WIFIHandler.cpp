...
{
    _model = new WifiListModel(this);
}

void WIFIHandler::setWifiOnArduino(const QString &ssid, const QString &password)
{
    QString value = ssid + "";
}
...
QList<QString> WIFIHandler::wifis() const
{
    return _model->wifis();
}

WifiListModel *WIFIHandler::model() const
{
    return _model;
}
